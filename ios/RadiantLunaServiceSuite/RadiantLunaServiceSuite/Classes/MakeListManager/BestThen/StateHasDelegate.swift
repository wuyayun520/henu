...
open class StateHasDelegate: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = StateHasDelegate.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func withBack() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(textWithoutChangeEqual),
    ...
    @objc private func textWithoutChangeEqual() {
