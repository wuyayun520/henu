...
/*: "blockList_ :*/
fileprivate let constLineUrl:[Character] = ["b","l","o","c","k","L","i","s","t"]
fileprivate let appMakeValue:[Character] = ["_"]
...
class MakeListManager: NSObject {
    ...
    func firstTitleApp(userId: String) {
    ...
    private func isothermal() -> String {
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(constLineUrl) + String(appMakeValue)) + "\(uid)")
        //: return filePath
        return filePath
    }
}
