...
struct CustomHandyJSON: HandyJSON {
    ...
    var momentPic: AtTransformable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [FrameHandyJSON]? // 相册
    ...
    var aiExtraInfo = BestAtModelType() // AI模型
    //: var vipSkinId = 0
...
struct AtTransformable: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [UserTipMeasurable]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct UserTipMeasurable: HandyJSON {
...
struct FrameHandyJSON: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func statusTo(compareTo: FrameHandyJSON) -> Bool {
        //: return
        return
...
struct BestAtModelType: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
