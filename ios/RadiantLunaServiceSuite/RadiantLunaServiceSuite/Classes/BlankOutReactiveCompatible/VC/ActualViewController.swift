...
/*: "Face verification" :*/
fileprivate let show_removeName:[Character] = ["F","a","c","e"," ","v","e","r","i","f","i","c"]
fileprivate let appMinimizeData:[Character] = ["a","t","i","o","n"]
...
class ActualViewController: LightThen {
    ...
    override func viewDidLoad() {
        ...
        title = (String(show_removeName) + String(appMinimizeData)).localized
        //: self.createUI()
        self.coatButton()
        //: self.createUIConstraint()
        self.swaddlingClothesTime()
    }

    // MARK: - Lazy load

    //: lazy var mainView: TalkingVerificationExampleView = {
    lazy var mainView: DirectionThen = {
        //: let view = TalkingVerificationExampleView()
        let view = DirectionThen()
        //: return view
        return view
        //: }()
    }()
...
extension ActualViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
        ...
        self.dismiss(animated: true) {
            ...
            if let photo = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                ...
                if self.isRegisterPush {
                    ...
                    let vc = AddStatusViewController(photoImage: photo)
...
extension ActualViewController {
    ...
    func coatButton() {
        ...
        mainView.btnClickBlock = { [weak self] () in
            ...
            CellPermissionTool.viewBlock(true) { isOpen in
