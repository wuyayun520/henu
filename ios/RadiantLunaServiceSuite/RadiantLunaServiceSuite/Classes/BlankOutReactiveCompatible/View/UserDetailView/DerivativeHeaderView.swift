...
fileprivate let show_addKey:[UInt8] = [0x1f,0x18,0x1f,0x2,0x5e,0x15,0x19,0x12,0x13,0x4,0x4c,0x5f,0x56,0x1e,0x17,0x5,0x56,0x18,0x19,0x2,0x56,0x14,0x13,0x13,0x18,0x56,0x1f,0x1b,0x6,0x1a,0x13,0x1b,0x13,0x18,0x2,0x13,0x12]

/*: "icon_userdetail_header_shadow" :*/
fileprivate let noti_dataValue:String = "in more returnicon_"
fileprivate let showPathValue:String = "etaiworld"
fileprivate let main_businessId:String = "share image original equalr_shado"
fileprivate let kReplyKey:String = "to"

/*: "icon_lounge" :*/
fileprivate let const_faceStr:[Character] = ["i","c","o","n","_","l"]
fileprivate let userNoseViewText:[Character] = ["o","u","n","g","e"]

/*: "Official" :*/
fileprivate let noti_pairImageKey:[Character] = ["O","f"]
fileprivate let kEqualContent:[Character] = ["f","i","c","i","a","l"]

/*: "Reviewing" :*/
fileprivate let showAddAllowKey:String = "Reviewititle to true cancel"
fileprivate let const_makeFemaleText:String = "path"

/*: "#FF506D" :*/
fileprivate let appRestoreRenderStr:[Character] = ["#","F","F","5","0","6","D"]

/*: "icon_user_detail_intimate_header" :*/
fileprivate let k_toTitle:[UInt8] = [0x26,0x2c,0x20,0x21,0x10,0x3a,0x3c,0x2a,0x3d,0x10,0x2b,0x2a,0x3b,0x2e,0x26,0x23,0x10,0x26,0x21,0x3b,0x26,0x22,0x2e,0x3b,0x2a,0x10,0x27,0x2a,0x2e,0x2b,0x2a,0x3d]

/*: "?toUid= :*/
fileprivate let notiSectionValue:[Character] = ["?","t","o","U","i","d"]
fileprivate let main_tabKey:[Character] = ["="]

/*: "AccountItemCell" :*/
fileprivate let noti_labData:String = "TUserfatal white cell"
fileprivate let mainReplyStorageMessage:String = "self premium type make giftlHea"
fileprivate let const_addStr:String = "Cellvar blind"

/*: "#FFFFFF" :*/
fileprivate let app_takeKey:String = "background center#F"
fileprivate let constLabelMsg:String = "actionactionactionactionaction"

/*: "#BDB8B5" :*/
fileprivate let appContentBlockUrl:[Character] = ["#","B","D","B","8","B"]
fileprivate let appStatusTitle:String = "5"

/*: "head_detail_bottom" :*/
fileprivate let kSharedTitle:String = "head_type shared top push"
fileprivate let appListMessage:String = "_bottocontent type group"
fileprivate let app_willId:String = "M"

/*: "#2DF2FF" :*/
fileprivate let main_labelName:String = "#2DF2Fmain self transform gift self"
fileprivate let constMakeId:String = "custom"

/*: "Live" :*/
fileprivate let showWhiteMessage:[Character] = ["L","i","v","e"]

/*: "#48FF1E" :*/
fileprivate let const_afterUrl:String = "path lab model title shape#48FF1E"

/*: "Online" :*/
fileprivate let const_arrayModeMessage:String = "you size giftOnline"

/*: "#FF4B7F" :*/
fileprivate let constShowId:String = "#FF4B7Fi extension"

/*: "busy" :*/
fileprivate let app_dataPath:String = "busview"
...
let user_successFormat = (302.0 + app_itemTitle)

//: class TalkingUserDetailHeaderView: UIView {
class DerivativeHeaderView: UIView {
    //: var VideoCallBlock: (() -> Void)?
    var VideoCallBlock: (() -> Void)?
    //: private var userInfoModel = TalkingUserInfoModel()
    private var userInfoModel = CustomHandyJSON()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_addKey.map{$0^118}, encoding: .utf8)!)
    }
    ...
    private lazy var shadowBgView: UIImageView = {
        ...
        let v = UIImageView(image: UIImage.bundle(name: (String(noti_dataValue.suffix(5)) + "userd" + showPathValue.replacingOccurrences(of: "world", with: "l") + "_heade" + String(main_businessId.suffix(7)) + kReplyKey.replacingOccurrences(of: "to", with: "w"))))
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var vipBgView: UIImageView = {
        ...
        v.frame = CGRect(x: 0, y: user_successFormat - 15, width: main_colorData, height: 15)
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var nicknameLab: UILabel = {
        ...
        lab.font = UIFont.replyName(type: .Medium, fontSize: 19)
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.bundle(name: (String(const_faceStr) + String(userNoseViewText)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var officalImgV: UIButton = {
        ...
        img.setTitle((String(noti_pairImageKey) + String(kEqualContent)).localized, for: .normal)
    ...
    private lazy var onlineImgV: BlockShouldShirtButton = {
    ...
    private lazy var liveView: MinVideoStreamsView = {
        //: let v = UserLivePullStreamsView()
        let v = MinVideoStreamsView()
        //: v.isHidden = true
        v.isHidden = true
        //: v.playEndBlock = {
        v.playEndBlock = {
        ...
        v.tapGestureBlock = { [weak self] in
            ...
            guard let self = self else { return }
            //: CombineAccountEnclaveDecisionMakerThen.share.func_audiencePushToLiveRoomVC(uid: self.userInfoModel.uid, enterType: .userDetail)
            CombineAccountEnclaveDecisionMakerThen.share.bringHomeType(uid: self.userInfoModel.uid, enterType: .userDetail)
        }
        //: return v
        return v
        //: }()
    ...
    private lazy var reViewingLB: UILabel = {
        ...
        lb.text = (String(showAddAllowKey.prefix(7)) + const_makeFemaleText.replacingOccurrences(of: "path", with: "ng")).localized
        //: lb.textColor = .white
        lb.textColor = .white
        //: lb.backgroundColor = UIColor.init(hex: "#FF506D")
        lb.backgroundColor = UIColor(hex: (String(appRestoreRenderStr)))
    ...
    lazy var lastLoginLab: UILabel = {
        ...
        lb.font = .replyName(type: .Medium, fontSize: 12)
        //: lb.textColor = .white
        lb.textColor = .white
        //: return lb
        return lb
    ...
    private lazy var intimateBtn: BlockShouldShirtButton = {
        //: let btn = TalkingButton()
        let btn = BlockShouldShirtButton()
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_user_detail_intimate_header"), for: .normal)
        btn.setImage(UIImage.bundle(name: String(bytes: k_toTitle.map{$0^79}, encoding: .utf8)!), for: .normal)
        //: btn.isHidden = true
        btn.isHidden = true
        //: btn.addTarget(self, action: #selector(intimateBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(modelStart), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension DerivativeHeaderView {
    /// 查看视频
    //: private func goToVideo() {
    private func haulUp() {
        //: let vc = TalkingMomentVideoVC.init(videoPath: self.userInfoModel.videoUrl)
        let vc = ImagePlayerDelegate(videoPath: self.userInfoModel.videoUrl)
        //: if IconContainerAppManager.share.loginUid != self.userInfoModel.uid {
        if IconContainerAppManager.share.loginUid != self.userInfoModel.uid {
    ...
    private func digitizer(_ index: Int) {
        ...
        let vc = VideoImageReactiveCompatible(momentModel: currenModel, index: index, type: .normal)
        //: self.currentViewController()?.navigationController?.pushViewController(vc, animated: true)
        self.actionLatest()?.navigationController?.pushViewController(vc, animated: true)
    }

    //: @objc func intimateBtnClick() {
    @objc func modelStart() {
        //: let url = TalkingWebManager.getFullUrl(urlType: .Intimate) + "?toUid=\(self.userInfoModel.uid)"
        let url = ShouldMomentManager.meApp(urlType: .Intimate) + (String(notiSectionValue) + String(main_tabKey)) + "\(self.userInfoModel.uid)"
...
extension DerivativeHeaderView: JXBannerDataSource {
    ...
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        ...
        return JXBannerCellRegister(type: AccountItemCell.self, reuseIdentifier: (String(noti_labData.prefix(5)) + "Detai" + String(mainReplyStorageMessage.suffix(4)) + "derItem" + String(const_addStr.prefix(4))))
    }
    ...
    func jxBanner(_: JXBannerType, cellForItemAt index: Int, cell: UICollectionViewCell) -> UICollectionViewCell {
        ...
        if index == 0 && userInfoModel.sex == ThemeTitleScalarLiteral.female.rawValue && userInfoModel.videoUrl.count > 1 { // 视频
            //: bannerCell.setVideoView()
            bannerCell.postpose()
            //: bannerCell.configModel(videoUrl: userInfoModel.videoUrl, imgUrl: userInfoModel.cover)
            bannerCell.anPath(videoUrl: userInfoModel.videoUrl, imgUrl: userInfoModel.cover)
            ...
            bannerCell.bgImgView.tillFirstBar(urlStr: urlStr, placeImg: UIImage.standUpMy())
        }
    ...
    func jxBanner(_: JXBannerType, centerIndex: Int, centerCell _: UICollectionViewCell) {
        //: guard userInfoModel.uid == IconContainerAppManager.share.loginUid else {
        guard userInfoModel.uid == IconContainerAppManager.share.loginUid else {
            //: return
            return
        }
    ...
    func jxBanner(pageControl _: JXBannerType, numberOfPages _: Int, coverView: UIView, builder: JXBannerPageControlBuilder) -> JXBannerPageControlBuilder {
        ...
        pageControl.activeColor = UIColor(hex: (String(app_takeKey.suffix(2)) + constLabelMsg.replacingOccurrences(of: "action", with: "F")))!
        //: pageControl.inactiveColor = UIColor(hex: "#BDB8B5")!
        pageControl.inactiveColor = UIColor(hex: (String(appContentBlockUrl) + appStatusTitle.capitalized))!
...
extension DerivativeHeaderView: JXBannerDelegate {
    ...
    public func jxBanner(_: JXBannerType, didSelectItemAt index: Int) {
        //: if index == 0 && userInfoModel.sex == Gender.female.rawValue && userInfoModel.videoUrl.count>1 {
        if index == 0 && userInfoModel.sex == ThemeTitleScalarLiteral.female.rawValue && userInfoModel.videoUrl.count > 1 {
            //: goToVideo()
            haulUp()
            ...
            if userInfoModel.sex == ThemeTitleScalarLiteral.female.rawValue && userInfoModel.videoUrl.count > 1 && curren > 0 {
                //: curren -= 1
                curren -= 1
            }
            //: goToPhoto(curren)
...
extension DerivativeHeaderView {
    ...
    func addBar(_ userModel: CustomHandyJSON) {
        ...
        if userModel.sex == ThemeTitleScalarLiteral.female.rawValue && userModel.videoUrl.count > 1 {
        ...
        let normalImg = UIImage.bundle(name: (String(kSharedTitle.prefix(5)) + "detail" + String(appListMessage.prefix(6)) + app_willId.lowercased())).withTintColor(.white)
        //: if userModel.loungePlus {
        if userModel.loungePlus {
            //: if let vipModel = IconContainerAppManager.share.appUserConfigMode.vipSetting.filter({$0.vipSkinId == userModel.vipSkinId}).first {
            if let vipModel = IconContainerAppManager.share.appUserConfigMode.vipSetting.filter({ $0.vipSkinId == userModel.vipSkinId }).first {
                //: vipBgView.setUrlImage(urlStr: vipModel.vipSkinTop, placeImg: normalImg)
                vipBgView.tillFirstBar(urlStr: vipModel.vipSkinTop, placeImg: normalImg)
            }
            //: } else {
        } else {
        ...
        self.nicknameLab.textColor = userModel.loungePlus ? .videoColor() : .white
        ...
        if userModel.intimateUrl.count > 0 {
            ...
            intimateImgV.pagePush(urlStr: userModel.intimateUrl)
        }
        // 在线状态
        ...
        if userModel.livePlayUrl.count > 0 {
            ...
            let image = UIImage.positionMoment(color: UIColor(hex: (String(main_labelName.prefix(6)) + constMakeId.replacingOccurrences(of: "custom", with: "F")))!, size: CGSize(width: 8, height: 8))
            //: onlineImgV.setImage(image.auditory(), for: .normal)
            onlineImgV.setImage(image.auditory(), for: .normal)
            //: onlineImgV.setTitle("Live".localized, for: .normal)
            onlineImgV.setTitle((String(showWhiteMessage)).localized, for: .normal)
            ...
            let image = UIImage.positionMoment(color: UIColor(hex: (String(const_afterUrl.suffix(7))))!, size: CGSize(width: 8, height: 8))
            //: onlineImgV.setImage(image.auditory(), for: .normal)
            onlineImgV.setImage(image.auditory(), for: .normal)
            //: onlineImgV.setTitle("Online".localized, for: .normal)
            onlineImgV.setTitle((String(const_arrayModeMessage.suffix(6))).localized, for: .normal)
            ...
            let image = UIImage.positionMoment(color: UIColor(hex: (String(constShowId.prefix(7))))!, size: CGSize(width: 8, height: 8))
            //: onlineImgV.setImage(image.auditory(), for: .normal)
            onlineImgV.setImage(image.auditory(), for: .normal)
            //: onlineImgV.setTitle("busy".localized, for: .normal)
            onlineImgV.setTitle((app_dataPath.replacingOccurrences(of: "view", with: "y")).localized, for: .normal)
            //: } else {
        } else {
        ...
        // 直播
        //: if IconContainerAppManager.share.loginUid != userModel.uid &&
        if IconContainerAppManager.share.loginUid != userModel.uid,
        ...
        if liveView.isHidden == false {
            ...
            liveView.queryCohabit(liveUrl: userModel.livePlayUrl)
        }
    }

    /// 添加视图
    //: private func setupSubviews() {
    private func cleanSize() {
    ...
    private func fromStart() {
        ...
        liveView.snp.makeConstraints { make in
            ...
            make.top.equalTo(app_itemTitle + 80)
        ...
        reViewingLB.snp.makeConstraints { make in
            ...
            make.top.equalToSuperview().offset(app_itemTitle + 15)
