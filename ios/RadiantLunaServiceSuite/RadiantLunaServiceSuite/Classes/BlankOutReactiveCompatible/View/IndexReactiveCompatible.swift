...
fileprivate let appSocialMessage:[UInt8] = [0xb,0x10,0xb,0x16,0xca,0x5,0x11,0x6,0x7,0x14,0xdc,0xcb,0xc2,0xa,0x3,0x15,0xc2,0x10,0x11,0x16,0xc2,0x4,0x7,0x7,0x10,0xc2,0xb,0xf,0x12,0xe,0x7,0xf,0x7,0x10,0x16,0x7,0x6]

				fileprivate func viewData(custom num: UInt8) -> UInt8 {
...
/*: "btn_me_edit" :*/
fileprivate let constBackPath:[Character] = ["b","t","n","_","m","e","_"]
fileprivate let appPositionFormalValue:[Character] = ["e","d","i","t"]
...
class IndexReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appSocialMessage.map{viewData(custom: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.bundle(name: (String(constBackPath) + String(appPositionFormalValue))))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.textColor = UIColor.colorData()
...
extension IndexReactiveCompatible {
    ...
    func giftWith(titile: String, iconStr: String, isShowDet: Bool) {
        //: titleBLB.text = titile
        titleBLB.text = titile
        //: iconImg.image = UIImage.BundleImageNamed(name: iconStr)
        iconImg.image = UIImage.bundle(name: iconStr)
