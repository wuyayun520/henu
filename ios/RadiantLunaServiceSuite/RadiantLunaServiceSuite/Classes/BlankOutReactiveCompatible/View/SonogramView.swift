...
fileprivate let main_addTransformKey:[UInt8] = [0x28,0x2f,0x28,0x35,0x69,0x22,0x2e,0x25,0x24,0x33,0x7b,0x68,0x61,0x29,0x20,0x32,0x61,0x2f,0x2e,0x35,0x61,0x23,0x24,0x24,0x2f,0x61,0x28,0x2c,0x31,0x2d,0x24,0x2c,0x24,0x2f,0x35,0x24,0x25]

				private func tempExtra(white num: UInt8) -> UInt8 {
					return num ^ 65
				}

/*: "btn_me_edit" :*/
fileprivate let showTicketToName:[Character] = ["b","t","n","_","m"]
fileprivate let constSourceId:[Character] = ["e","_","e","d","i","t"]

/*: "Program" :*/
fileprivate let k_mainPath:String = "corner infoProgram"
...
class SonogramView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_addTransformKey.map{tempExtra(white: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var backBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(vocalism), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var editImg: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.bundle(name: (String(showTicketToName) + String(constSourceId))))
        //: imag.isUserInteractionEnabled = false
        imag.isUserInteractionEnabled = false
        //: return imag
        return imag
...
extension SonogramView {
    //: func setViewData(title: String, icon: String) {
    func titleAcross(title: String, icon: String) {
        //: iconImg.image = UIImage.BundleImageNamed(name: icon)
        iconImg.image = UIImage.bundle(name: icon)
        //: titleLab.text = title.localized
        titleLab.text = title.localized
        //: if title == "Program" {
        if title == (String(k_mainPath.suffix(7))) {
    ...
    func toButton() {
        ...
        backBtn.meanSunRadii(width: main_colorData - 30, height: 50, corners: [.topLeft, .topRight], cornerRadii: .init(width: 8, height: 8))
    }
}
