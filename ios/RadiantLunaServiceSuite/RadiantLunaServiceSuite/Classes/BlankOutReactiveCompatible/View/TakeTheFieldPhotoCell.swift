...
fileprivate let main_changeTitle:[UInt8] = [0x52,0x57,0x52,0x5d,0x11,0x4c,0x58,0x4d,0x4e,0x5b,0x23,0x12,0x9,0x51,0x4a,0x5c,0x9,0x57,0x58,0x5d,0x9,0x4b,0x4e,0x4e,0x57,0x9,0x52,0x56,0x59,0x55,0x4e,0x56,0x4e,0x57,0x5d,0x4e,0x4d]

				fileprivate func modelEnable(edit num: UInt8) -> UInt8 {
...
/*: "#333333" :*/
fileprivate let show_privacyStr:[Character] = ["#","3","3","3","3","3","3"]

/*: "My photos" :*/
fileprivate let k_containerMessage:[Character] = ["M","y"," ","p","h","o","t","o","s"]

/*: "#999999" :*/
fileprivate let app_viewStr:String = "#99999"
fileprivate let appRequestPath:String = "9"

/*: "Click to change or delete photo." :*/
fileprivate let show_fileStr:[UInt8] = [0x25,0xa,0xf,0x5,0xd,0x46,0x12,0x9,0x46,0x5,0xe,0x7,0x8,0x1,0x3,0x46,0x9,0x14,0x46,0x2,0x3,0xa,0x3,0x12,0x3,0x46,0x16,0xe,0x9,0x12,0x9,0x48]

/*: "btn_me_edit_photo_add_nor" :*/
fileprivate let notiViewId:[Character] = ["b","t","n","_","m","e","_","e","d","i","t","_"]
fileprivate let k_afterKey:String = "psourceot"
fileprivate let showContentStr:String = "to modelo_ad"

/*: "btn_me_edit_photo_add_pre" :*/
fileprivate let main_labelUrl:String = "btn_input medium self color"
fileprivate let k_giftDetailValue:String = "top frame numberdit_p"
fileprivate let app_dataValue:String = "self filteradd_pr"
fileprivate let user_requestName:[Character] = ["e"]

/*: "btn_me_edit_photo_delete" :*/
fileprivate let show_popKey:String = "apply var true true headbtn_"
fileprivate let kClearFormat:String = "text frame image fort_ph"
fileprivate let userRangeKey:String = "elenamee"
...
public protocol ThirdReactiveCompatible: NSObject {
    /// 图片add
...
class TakeTheFieldPhotoCell: UITableViewCell {
    //: let disposeBag = DisposeBag()
    let disposeBag = DisposeBag()
    //: var count = 0
    var count = 0
    //: open weak var delegate: EditPhotoDelegate?
    open weak var delegate: ThirdReactiveCompatible?
...
//        showMessageView()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_changeTitle.map{modelEnable(edit: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var titleBLB: UILabel = {
        ...
        lb.textColor = UIColor(hex: (String(show_privacyStr)))
        //: lb.text = "My photos".localized
        lb.text = (String(k_containerMessage)).localized
    ...
    lazy var messageLB: UILabel = {
        ...
        lb.font = UIFont.replyName(type: .Regular, fontSize: 12)
        //: lb.textColor = UIColor.init(hex: "#999999")
        lb.textColor = UIColor(hex: (app_viewStr.capitalized + appRequestPath.capitalized))
        //: lb.text = "Click to change or delete photo.".localized
        lb.text = String(bytes: show_fileStr.map{$0^102}, encoding: .utf8)!.localized
        //: return lb
        return lb
        //: }()
    }()
...
extension TakeTheFieldPhotoCell {
    ...
    func confirm() {
        ...
        for i in 0 ..< 9 {
            ...
            colorBtn.setBackgroundImage(.bundle(name: (String(notiViewId) + k_afterKey.replacingOccurrences(of: "source", with: "h") + String(showContentStr.suffix(4)) + "d_nor")), for: .normal)
            //: colorBtn.setBackgroundImage(.BundleImageNamed(name: "btn_me_edit_photo_add_pre"), for: .highlighted)
            colorBtn.setBackgroundImage(.bundle(name: (String(main_labelUrl.prefix(4)) + "me_e" + String(k_giftDetailValue.suffix(5)) + "hoto_" + String(app_dataValue.suffix(6)) + String(user_requestName))), for: .highlighted)
            ...
            deleteBtn.setBackgroundImage(.bundle(name: (String(show_popKey.suffix(4)) + "me_edi" + String(kClearFormat.suffix(4)) + "oto_d" + userRangeKey.replacingOccurrences(of: "name", with: "t"))), for: .normal)
            ...
            deleteBtn.rx.tap.subscribe(onNext: { [weak self] in
                ...
                self.pairSender(sender: deleteBtn)
                //: }).disposed(by: disposeBag)
            }).disposed(by: disposeBag)
        }
    }
    ...
    @objc func noValue(sender: UIButton) {
        //: var isReturn = false
        var isReturn = false
        ...
        CellPermissionTool.targetEvent(true) { (isOpen: Bool) in
            ...
            if isOpen {
                ...
                let vc = StateThen.emptyDown(maxCount: 9 - self.count, allowPhoto: true, allowVideo: false)
                ...
                vc.didFinishPickingPhotosHandle = { [weak self] (photos: [UIImage]?,
                        ...
                        if photos!.count > 0 {
                            ...
                            self.delegate?.startPhotoTo(photos!)
                        }
                        //: return
                }
            }
    ...
    func equalSelete(selete: [FrameHandyJSON]) {
        ...
        for i in 0 ..< selete.count {
            ...
            if i < allPhoto.count {
                ...
                if selete[i].isLocal {
                    ...
                    Btn.sayFarewell(urlStr: selete[i].url)
                }
                //: _ = Btn.subviews.map { view in
                _ = Btn.subviews.map { view in
                    //: if (view is UIButton) {
