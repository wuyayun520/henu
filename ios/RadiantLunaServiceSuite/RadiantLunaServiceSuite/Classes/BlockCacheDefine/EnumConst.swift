...
enum AddKeyRepresentable: String {
    //: case AppleLogin
...
enum TalkingThemeVariantRequestType {
    //: case GET
    case GET
    //: case POST
    case POST
...
enum PlaceboEffectAccountSignedNumeric: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
/// 性别
//: enum Gender: String {
enum ThemeTitleScalarLiteral: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum LeadingResponseSubscriptType: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum EventBestStarStatus: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
@objc enum MinExpressionConvertible: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum MaleDefaultsSerializable: Int {
    //: case Unavailable = 0
...
enum FrameCellType: CaseIterable {
