...
struct CoveredOptionContainerInset {
    //: let top: CGFloat = 5.0
    let top: CGFloat = 5.0
...
class TertiaryThen: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        self.placeholder(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        self.placeholder(placeholder: nil, placeholderColor: nil)
    }
}
...
extension TertiaryThen {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func placeholder(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(DirectionLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(DirectionLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-DirectionLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: CoveredOptionContainerInset().top, left: CoveredOptionContainerInset().left, bottom: CoveredOptionContainerInset().bottom, right: CoveredOptionContainerInset().right)
...
extension TertiaryThen: UITextViewDelegate {
