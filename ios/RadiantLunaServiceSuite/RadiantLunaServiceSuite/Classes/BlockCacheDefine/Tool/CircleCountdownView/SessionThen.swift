...
fileprivate let dataMakeModelEqualMsg:[UInt8] = [0xc1,0xc6,0xc1,0xdc,0x80,0xcb,0xc7,0xcc,0xcd,0xda,0x92,0x81,0x88,0xc0,0xc9,0xdb,0x88,0xc6,0xc7,0xdc,0x88,0xca,0xcd,0xcd,0xc6,0x88,0xc1,0xc5,0xd8,0xc4,0xcd,0xc5,0xcd,0xc6,0xdc,0xcd,0xcc]
...
let appPositionSkipMessage = 3.0

//: class CircleCountdownView: UIView {
class SessionThen: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.appValueColor() {
    var roundBgColor = UIColor.colorData() {
        //: willSet {
        willSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dataMakeModelEqualMsg.map{$0^168}, encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.replyName(type: .Semibold, fontSize: 19)
    ...
    private lazy var bPath: UIBezierPath = {
        ...
        let rect = CGRect(x: appPositionSkipMessage / 2,
                          //: y: CIRCLECOUNTDOWNLINE_W/2,
                          y: appPositionSkipMessage / 2,
                          //: width: self.frame.width-CIRCLECOUNTDOWNLINE_W,
                          width: self.frame.width - appPositionSkipMessage,
                          //: height: self.frame.height-CIRCLECOUNTDOWNLINE_W)
                          height: self.frame.height - appPositionSkipMessage)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.colorData().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = appPositionSkipMessage
...
extension SessionThen {
    ...
    func moralsPush(totalTime: Int, currTime: Int) {
