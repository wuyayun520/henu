...
//: @objcMembers public class EqualEntiretycostModel: JSONModel {
@objcMembers public class EqualEntiretycostModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = CellDataExpressionConvertible.Face
...
//: @objc extension EqualEntiretycostModel {
@objc extension EqualEntiretycostModel {
    //: func initWith(suiteType: BeautyItemType)-> EqualEntiretycostModel {
    func suite(suiteType: CellDataExpressionConvertible) -> EqualEntiretycostModel {
        //: let model = EqualEntiretycostModel.init()
        let model = EqualEntiretycostModel()
