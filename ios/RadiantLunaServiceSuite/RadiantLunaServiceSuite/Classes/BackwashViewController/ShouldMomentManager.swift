...
enum AppHashable: String, CaseIterable {
...
enum SuccessExpressionConvertible: String {
...
class ShouldMomentManager: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func meApp(urlType: SuccessExpressionConvertible) -> String {
        //: var url = IconContainerAppManager.share.appConfigMode.urlH5Domain
        var url = IconContainerAppManager.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(IconContainerAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : IconContainerAppManager.share.appUserConfigMode.fullRechargePage)
            url.append(IconContainerAppManager.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : IconContainerAppManager.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(IconContainerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : IconContainerAppManager.share.appUserConfigMode.halfRechargePage)
            url.append(IconContainerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : IconContainerAppManager.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = IconContainerAppManager.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = IconContainerAppManager.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            //: url.append(IconContainerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(IconContainerAppManager.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
