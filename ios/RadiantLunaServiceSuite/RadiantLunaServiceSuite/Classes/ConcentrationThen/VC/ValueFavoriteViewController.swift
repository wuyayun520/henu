...
fileprivate let dataEqualPushValue:[Character] = ["A","r","e","a","C","o","d","e","C","h","o","i","c","e","C","e","l","l","I"]
fileprivate let showMinValue:String = "current"

/*: "init(coder:) has not been implemented" :*/
fileprivate let kMakeEyeId:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Select Country Code" :*/
fileprivate let userArrayUrl:String = "Selectview group true"
fileprivate let dataServerLabTitle:String = "self info datantry "
fileprivate let kIndexMessage:[Character] = ["C","o","d","e"]

/*: "#F4F6FA" :*/
fileprivate let user_lineKey:String = "#F4F6var model result from true"
fileprivate let main_textName:[Character] = ["F","A"]
...
// __CLOSE_PRINT__
//
//  ValueFavoriteViewController.swift
//  AbroadTalking
//
...
class ValueFavoriteViewController: LightThen {
    //: public var backCountryCode: ((TalkingAreaModel) -> Void)?
    public var backCountryCode: ((EffectEnterMeasurable) -> Void)?

    //: private let TalkingAreaCodeChoiceCellID = "AreaCodeChoiceCellID"
    private let TalkingAreaCodeChoiceCellID = (String(dataEqualPushValue) + showMinValue.replacingOccurrences(of: "current", with: "D"))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kMakeEyeId.reversed(), encoding: .utf8)!)
    }
    ...
    override func viewDidLoad() {
        ...
        self.title = (String(userArrayUrl.prefix(6)) + " Cou" + String(dataServerLabTitle.suffix(5)) + String(kIndexMessage)).localized
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(AddViewCell.classForCoder(), forCellReuseIdentifier: TalkingAreaCodeChoiceCellID)
        ...
        tableView.backgroundColor = UIColor(hex: (String(user_lineKey.prefix(5)) + String(main_textName)))
        //: return tableView
        return tableView
        //: }()
    }()
...
extension ValueFavoriteViewController {
    ...
    private func point() {
        ...
        for areaModel: EffectEnterMeasurable in arr {
        ...
        for index in 0 ..< sectionNumb {
            ...
            let sortArr = collation.sortedArray(from: tempArr, collationStringSelector: #selector(getter: EffectEnterMeasurable().areaName))
...
extension ValueFavoriteViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if sectionArray.count > section {
            ...
            let array: [EffectEnterMeasurable] = sectionArray[section] as! [EffectEnterMeasurable]
            //: return array.count
            return array.count
        }
        //: return 0
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell: AddViewCell = tableView.dequeueReusableCell(withIdentifier: TalkingAreaCodeChoiceCellID, for: indexPath) as! AddViewCell
        //: let array: [TalkingAreaModel] = sectionArray[indexPath.section] as! [TalkingAreaModel]
        let array: [EffectEnterMeasurable] = sectionArray[indexPath.section] as! [EffectEnterMeasurable]
        //: cell.func__updateUIWithModel(areaModel: array[indexPath.row])
        cell.transparency(areaModel: array[indexPath.row])
    ...
    func tableView(_: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headView.frame = CGRect(x: 0, y: 0, width: main_colorData, height: 30)
        ...
        label.frame = CGRect(x: 15, y: 0, width: main_colorData - 30, height: 30)
