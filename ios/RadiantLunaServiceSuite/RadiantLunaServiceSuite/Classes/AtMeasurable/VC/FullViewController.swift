...
class FullViewController: LightThen {
    ...
    lazy var topView: TopView = {
        ...
        let view = TopView(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: SuccessIndexReactiveCompatible = {
    ...
    lazy var usePhotoView: ActualInfoView = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = ActualInfoView(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension FullViewController {
    ...
    func photo(modle: AtMeasurable) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==IconContainerAppManager.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == IconContainerAppManager.share.loginUserMode.sex
        }
