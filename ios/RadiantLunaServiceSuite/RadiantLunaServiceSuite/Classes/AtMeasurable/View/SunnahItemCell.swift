...
fileprivate let user_containerFormat:[UInt8] = [0xf2,0xf5,0xf2,0xef,0xb3,0xf8,0xf4,0xff,0xfe,0xe9,0xa1,0xb2,0xbb,0xf3,0xfa,0xe8,0xbb,0xf5,0xf4,0xef,0xbb,0xf9,0xfe,0xfe,0xf5,0xbb,0xf2,0xf6,0xeb,0xf7,0xfe,0xf6,0xfe,0xf5,0xef,0xfe,0xff]

				private func rationalMotiveModel(with num: UInt8) -> UInt8 {
					return num ^ 155
				}

/*: "icon_home_v" :*/
fileprivate let userEmptyValue:[Character] = ["i","c","o","n","_","h","o","m","e","_","v"]

/*: "icon_lounge" :*/
fileprivate let noti_characterId:[Character] = ["i","c","o"]
fileprivate let app_viewSharedKey:String = "n_loungeraw count main var view"

/*: "#AAAAAA" :*/
fileprivate let kTimeFormat:String = "#Alab color"
fileprivate let constOfValue:String = "skinskinA"

/*: "icon_moment_nor_report" :*/
fileprivate let mainDataKey:String = "inner"
fileprivate let constLabelValue:[Character] = ["c","o","n","_","m","o","m","e","n","t","_","n","o","r","_","r","e","p","o","r","t"]

/*: "img_me_edit_photo_default" :*/
fileprivate let main_levelValue:String = "else mean false equalimg_"
fileprivate let main_dateKey:String = "t_phouser time make image"
fileprivate let kVideoColorTitle:String = "messageult"

/*: "icon_home_boy" :*/
fileprivate let data_firstLeadingTitle:String = "icon_hreturn action float share"
fileprivate let main_textId:[Character] = ["b","o","y"]

/*: "icon_home_girl" :*/
fileprivate let userLayerData:[Character] = ["i","c","o","n","_","h","o","m","e","_","g","i","r"]
fileprivate let notiColorData:[Character] = ["l"]

/*: "level_" :*/
fileprivate let showMakeMsg:String = "level_share size"
...
class SunnahItemCell: UITableViewCell {
    //: var cid = ""
    var cid = ""
    //: var uid = ""
    var uid = ""
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_containerFormat.map{rationalMotiveModel(with: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var iconBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(numberLoad), for: .touchUpInside)
        //: self.addSubview(btn)
        self.addSubview(btn)
        //: return btn
        return btn
    ...
    lazy var cardImgView: UIImageView = {
        ...
        img.image = UIImage.bundle(name: (String(userEmptyValue)))
    ...
    lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.bundle(name: (String(noti_characterId) + String(app_viewSharedKey.prefix(8))))
        //: self.addSubview(img)
        self.addSubview(img)
        //: return img
        return img
    ...
    lazy var timeLB: UILabel = {
        ...
        label.textColor = UIColor(hex: (String(kTimeFormat.prefix(2)) + constOfValue.replacingOccurrences(of: "skin", with: "AA")))
        //: self.addSubview(label)
        self.addSubview(label)
        //: return label
        return label
    ...
    lazy var BlockBtn: UIButton = {
        ...
        btn.setImage(UIImage.bundle(name: (mainDataKey.replacingOccurrences(of: "inner", with: "i") + String(constLabelValue))), for: .normal)
        //: btn.imageView?.contentMode = .scaleAspectFill
        btn.imageView?.contentMode = .scaleAspectFill
...
extension SunnahItemCell {
    //: @objc func clickBlockAction() {
    @objc func outInFilter() {
    ...
    @objc func honkyTonk(gestureRecongnizer: UIGestureRecognizer) {
    ...
    @objc func every() {
        ...
        let reportView = SuccessDataSource(frame: UIScreen.main.bounds, type: .reportCommentType, rId: cid)
        //: reportView.showReportViewIn(view: MaleMacroDefine.getWindow())
        reportView.beyondShow(view: MaleMacroDefine.penumbra())
    }
}
...
extension SunnahItemCell {
    ...
    func rhetorician(model: WayCommentModel) {
        //: cid = model.cid ?? ""
        cid = model.cid ?? ""
        //: uid = model.uid ?? ""
        uid = model.uid ?? ""
        //: iconBtn.setUrlImage(urlStr: model.headPic ?? "", placeImg: UIImage.BundleImageNamed(name: "img_me_edit_photo_default"))
        iconBtn.sayFarewell(urlStr: model.headPic ?? "", placeImg: UIImage.bundle(name: (String(main_levelValue.suffix(4)) + "me_edi" + String(main_dateKey.prefix(5)) + "to_de" + kVideoColorTitle.replacingOccurrences(of: "message", with: "fa"))))
        ...
        nameLabel.textColor = model.loungePlus ? .videoColor() : .colorData()
        ...
        case ThemeTitleScalarLiteral.male.rawValue:
            ...
            sexBtn.setBackgroundImage(UIImage.bundle(name: (String(data_firstLeadingTitle.prefix(6)) + "ome_" + String(main_textId))), for: .normal)
        //: break
        ...
        case ThemeTitleScalarLiteral.female.rawValue:
            ...
            sexBtn.setBackgroundImage(UIImage.bundle(name: (String(userLayerData) + String(notiColorData))), for: .normal)
        //: break
        //: default:
        default:
            //: break
        ...
        levelBtn.setBackgroundImage(UIImage.bundle(name: (String(showMakeMsg.prefix(6))) + String(model.level ?? 1)), for: .normal)
        ...
        contentLB.text = model.content
        //: BlockBtn.isHidden = IconContainerAppManager.share.loginUserMode.userID == model.uid
        BlockBtn.isHidden = IconContainerAppManager.share.loginUserMode.userID == model.uid
    }
}
...
extension SunnahItemCell {
    ...
    private func groupDown() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(outInFilter))
        //: self.addGestureRecognizer(tap)
        self.addGestureRecognizer(tap)

        //: let longPress = UILongPressGestureRecognizer(target: self, action: #selector(onLongTapCell(gestureRecongnizer:)))
        let longPress = UILongPressGestureRecognizer(target: self, action: #selector(honkyTonk(gestureRecongnizer:)))
