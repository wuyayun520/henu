...
fileprivate let show_sendValue:[UInt8] = [0x21,0x26,0x21,0x3c,0x60,0x2b,0x27,0x2c,0x2d,0x3a,0x72,0x61,0x68,0x20,0x29,0x3b,0x68,0x26,0x27,0x3c,0x68,0x2a,0x2d,0x2d,0x26,0x68,0x21,0x25,0x38,0x24,0x2d,0x25,0x2d,0x26,0x3c,0x2d,0x2c]

/*: "icon_chat_start" :*/
fileprivate let main_hiddenKey:String = "icnor"
fileprivate let constSegmentToMessage:[Character] = ["_","c","h","a","t","_","s","t","a","r","t"]

/*: "#752FE9" :*/
fileprivate let userModelContent:String = "#752FE9label super view view at"

/*: "#F5F5F5" :*/
fileprivate let app_atDataVarKey:String = "show error string data let#F5F5F"
fileprivate let dataCameraValue:[Character] = ["5"]

/*: "btn_feed_dianzan_nor" :*/
fileprivate let dataMakeAfterUrl:[UInt8] = [0x2b,0x3d,0x27,0x16,0x2f,0x2c,0x2c,0x2d,0x16,0x2d,0x20,0x28,0x27,0x33,0x28,0x27,0x16,0x27,0x26,0x3b]

				private func ofTo(data num: UInt8) -> UInt8 {
					return num ^ 73
				}

/*: "btn_feed_reply_nor" :*/
fileprivate let noti_oldModelUrl:String = "size let a viewbtn_fe"
fileprivate let main_priceUrl:String = "view appply_nor"
...
class PointFeedCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        setupWithinConstraint()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: show_sendValue.map{$0^72}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.bundle(name: (main_hiddenKey.replacingOccurrences(of: "nor", with: "on") + String(constSegmentToMessage)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(userModelContent.prefix(7))))
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(app_atDataVarKey.suffix(6)) + String(dataCameraValue)))
...
extension PointFeedCell {
    /// 刷新cell
    //: func refreshCell(_ model: TalkingRemindListModel) {
    func bulgeOutTag(_ model: CellModelType) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.tillFirstBar(urlStr: model.headPic, placeImg: UIImage.standUpMy())
        ...
        previewImgView.pagePush(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: dataMakeAfterUrl.map{ofTo(data: $0)}, encoding: .utf8)! : (String(noti_oldModelUrl.suffix(6)) + "ed_re" + String(main_priceUrl.suffix(7)))
        //: statusIcon.image = UIImage.BundleImageNamed(name: typeImgStr)
        statusIcon.image = UIImage.bundle(name: typeImgStr)
...
extension PointFeedCell {
    ...
    private func setupWithinConstraint() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((main_colorData - 128) / 2)
        }
