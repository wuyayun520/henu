...
fileprivate let constAddNamePath:[UInt8] = [0xfc,0xfb,0xfc,0xe1,0xbd,0xf6,0xfa,0xf1,0xf0,0xe7,0xaf,0xbc,0xb5,0xfd,0xf4,0xe6,0xb5,0xfb,0xfa,0xe1,0xb5,0xf7,0xf0,0xf0,0xfb,0xb5,0xfc,0xf8,0xe5,0xf9,0xf0,0xf8,0xf0,0xfb,0xe1,0xf0,0xf1]

/*: "icon_chat_start" :*/
fileprivate let constGiftValue:[Character] = ["i","c","o","n","_","c","h","a","t","_"]
fileprivate let main_mMediumMessage:[Character] = ["s","t","a","r","t"]

/*: "#EBEBEB" :*/
fileprivate let notiBackgroundViewCountData:String = "#"
fileprivate let dataNumberervalValue:[Character] = ["E","B","E","B","E","B"]

/*: "icon_talk_reply_voive" :*/
fileprivate let app_hideMsg:String = "icon_taltype make up view"
fileprivate let noti_barFormat:[Character] = ["k","_","r","e","p","l","y","_","v","o","i","v","e"]

/*: "#DCDCDC" :*/
fileprivate let dataMakePath:String = "out var#D"
fileprivate let dataJumpNorReturnName:String = "userDuserDuser"

/*: "text" :*/
fileprivate let noti_cellViewSourcePath:String = "bagexbag"

/*: "gift" :*/
fileprivate let noti_colorText:String = "GIFT"

/*: "Sent " :*/
fileprivate let showTabId:String = "Sent value content make"

/*: "audio" :*/
fileprivate let dataViewUrl:String = "auplano"

/*: "video" :*/
fileprivate let data_contentText:String = "maindeo"
...
class ContainerReactiveCompatible: UIButton {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constAddNamePath.map{$0^149}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.bundle(name: (String(constGiftValue) + String(main_mMediumMessage)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    lazy var audioView: UIView = {
        ...
        v.backgroundColor = UIColor(hex: (notiBackgroundViewCountData.capitalized + String(dataNumberervalValue)))
    ...
    lazy var audioImg: UIImageView = {
        ...
        img.image = UIImage.bundle(name: (String(app_hideMsg.prefix(8)) + String(noti_barFormat)))
        //: return img
        return img
        //: }()
    }()
    ...
    var direction: StreamScalar = .MsgDirectionIncoming {
        //: didSet {
        didSet {
            //: if direction == .MsgDirectionIncoming {
            if direction == .MsgDirectionIncoming {
                //: self.lineView.backgroundColor = UIColor.appValueDetailColor()
                self.lineView.backgroundColor = UIColor.valueColor()
                //: self.nameLab.textColor = UIColor.appValueDetailColor()
                self.nameLab.textColor = UIColor.valueColor()
                //: }else{
            } else {
                //: self.lineView.backgroundColor = UIColor(hex: "#DCDCDC")
                self.lineView.backgroundColor = UIColor(hex: (String(dataMakePath.suffix(2)) + dataJumpNorReturnName.replacingOccurrences(of: "user", with: "C")))
                //: self.nameLab.textColor = UIColor(hex: "#DCDCDC")
                self.nameLab.textColor = UIColor(hex: (String(dataMakePath.suffix(2)) + dataJumpNorReturnName.replacingOccurrences(of: "user", with: "C")))
            }
        }
    }
    ...
    var quoteModel: MainScoreModel? {
        ...
        didSet {
            ...
            if quoteModel.renderType == (noti_cellViewSourcePath.replacingOccurrences(of: "bag", with: "t")) {
                //: self.nameLab.text = quoteModel.sendName + ": " +  quoteModel.renderData.content
                self.nameLab.text = quoteModel.sendName + ": " + quoteModel.renderData.content
                //: }else if quoteModel.renderType == "gift" {
            } else if quoteModel.renderType == (noti_colorText.lowercased()) {
                //: self.nameLab.text = quoteModel.sendName + ": " + "Sent ".localized + quoteModel.renderData.giftNameLocal() + " x\(quoteModel.renderData.giftNum)"
                self.nameLab.text = quoteModel.sendName + ": " + (String(showTabId.prefix(5))).localized + quoteModel.renderData.titleBy() + " x\(quoteModel.renderData.giftNum)"
                //: }else if quoteModel.renderType == "audio" {
            } else if quoteModel.renderType == (dataViewUrl.replacingOccurrences(of: "plan", with: "di")) {
                ...
                if quoteModel.renderData.previewUrl.count > 0 && isExists {
                    ...
                    self.imgView.pagePush(urlStr: quoteModel.renderData.previewUrl)
                }
                //: spaceRight = 34
                spaceRight = 34
                //: }else if quoteModel.renderType == "video" {
            } else if quoteModel.renderType == (data_contentText.replacingOccurrences(of: "main", with: "vi")) {
                //: self.nameLab.text = quoteModel.sendName + ": "
                self.nameLab.text = quoteModel.sendName + ": "
                //: self.imgView.isHidden = false
                self.imgView.isHidden = false
                ...
                self.imgView.pagePush(urlStr: quoteModel.renderData.coverUrl)
                //: spaceRight = 34
                spaceRight = 34
            }
