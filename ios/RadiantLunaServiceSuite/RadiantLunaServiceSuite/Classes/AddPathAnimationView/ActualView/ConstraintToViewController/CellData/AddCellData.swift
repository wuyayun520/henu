...
@objc public enum EnterHashable: UInt {
...
@objc public enum StreamScalar: UInt {
 ...
 */
//: @objcMembers public class AddCellData: TCommonCellData {
@objcMembers public class AddCellData: ReplaceCellData {
    ...
    public var direction: StreamScalar = .MsgDirectionIncoming
    ...
    public var translateStatus: EnterHashable = .MsgTranslate_init
    ...
    public var msgModel: ScoreModel = ScoreModel()
    ...
    public var cellLayout: PopOutReactiveCompatible!
    ...
    public init(direction: StreamScalar) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.fromSquare()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = PopOutReactiveCompatible(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = PopOutReactiveCompatible(isIncomming: false)
    ...
    public func equalShared() -> CGSize {
        //: return CGSize.zero
        return CGSize.zero
    }
    ...
    public override func dimension(_ width: CGFloat) -> CGFloat {
