...
fileprivate let app_cookieName:[UInt8] = [0xed,0xea,0xed,0xf0,0xac,0xe7,0xeb,0xe0,0xe1,0xf6,0xbe,0xad,0xa4,0xec,0xe5,0xf7,0xa4,0xea,0xeb,0xf0,0xa4,0xe6,0xe1,0xe1,0xea,0xa4,0xed,0xe9,0xf4,0xe8,0xe1,0xe9,0xe1,0xea,0xf0,0xe1,0xe0]

				private func beanRound(path num: UInt8) -> UInt8 {
					return num ^ 132
				}
...
class FingertipThen: SharedItemView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_cookieName.map{beanRound(path: $0)}, encoding: .utf8)!)
    }
    ...
    override func nameColor() {
        ...
        let filePath = ActualThen.shared.observerAdd(fileName: (self.giftEffectModel?.mainFile)!, model: self.effectMsgModel!)
        ...
        parser?.parse(with: data! as Data, cacheKey: key, completionBlock: { [weak self] videoItem in
            ...
            self.delegate?.outValueName(effectItemView: self, success: true)
...
extension FingertipThen: SVGAPlayerDelegate {
