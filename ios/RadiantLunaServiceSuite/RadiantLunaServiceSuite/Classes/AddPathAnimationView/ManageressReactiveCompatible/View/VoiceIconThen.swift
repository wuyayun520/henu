...
fileprivate let dataShowFormat:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#E6BD8B" :*/
fileprivate let notiLeadingData:String = "view"
fileprivate let data_succeedFormat:[Character] = ["E","6","B","D","8","B"]

/*: "get json error" :*/
fileprivate let dataMakeMessage:String = "file equalget j"
fileprivate let app_greetKey:String = "RROR"
...
class VoiceIconThen: UIView {
    ...
    override init(frame: CGRect) {
        ...
        self.totalernalRepresentationChange()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: dataShowFormat.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var pointLab: UILabel = {
        ...
        lab.font = UIFont.replyName(type: .Semibold, fontSize: 24)
        //: lab.textColor = UIColor.init(hex: "#E6BD8B")
        lab.textColor = UIColor(hex: (notiLeadingData.replacingOccurrences(of: "view", with: "#") + String(data_succeedFormat)))
...
extension VoiceIconThen {
    //: func setPointData(point: String, isminiStr: Bool = false) {
    func priceGift(point: String, isminiStr: Bool = false) {
        ...
        let attributes = [.foregroundColor: UIColor(hex: (notiLeadingData.replacingOccurrences(of: "view", with: "#") + String(data_succeedFormat)))!, .font: UIFont.replyName(type: .Semibold, fontSize: isminiStr ? 15 : 24)] as [NSAttributedString.Key: Any]
        ...
        let attributes2 = [.foregroundColor: UIColor(hex: (notiLeadingData.replacingOccurrences(of: "view", with: "#") + String(data_succeedFormat)))!, .font: UIFont.replyName(type: .Semibold, fontSize: 14)] as [NSAttributedString.Key: Any]
        ...
        do {
            ...
            var url = ThemeReactiveCompatible.default.windowMake(type: .VideoCall_femalePoint)
            ...
            if QuantityRequestAddrTool.share.interfaceLang == FormAppSequence.ar.rawValue {
                ...
                url = ThemeReactiveCompatible.default.windowMake(type: .videoCall_femalePoint_ar)
                ...
                url = ThemeReactiveCompatible.default.windowMake(type: .videoCall_femalePoint_es)
                ...
                url = ThemeReactiveCompatible.default.windowMake(type: .videoCall_femalePoint_pt)
            }
            ...
            printLog(message: (String(dataMakeMessage.suffix(5)) + "son e" + app_greetKey.lowercased()))
        }
    }
}
...
extension VoiceIconThen {
    ...
    private func totalernalRepresentationChange() {
