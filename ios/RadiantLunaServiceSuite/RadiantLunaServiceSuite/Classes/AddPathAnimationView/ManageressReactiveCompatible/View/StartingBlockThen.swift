...
fileprivate let user_socialPath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_livetc_warn" :*/
fileprivate let user_sizeStr:String = "icoactive"
fileprivate let user_unknownTitle:String = "tc_watop true string view"
fileprivate let dataTableContent:String = "rstop"
...
class StartingBlockThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: user_socialPath.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.bundle(name: (user_sizeStr.replacingOccurrences(of: "active", with: "n") + "_live" + String(user_unknownTitle.prefix(5)) + dataTableContent.replacingOccurrences(of: "stop", with: "n")))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = IconContainerAppManager.share.appUserConfigMode.blockCameraPopupContent
        lab.text = IconContainerAppManager.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
