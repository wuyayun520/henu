...
fileprivate let mainSucceedKey:[UInt8] = [0x6d,0x72,0x6d,0x78,0x2c,0x67,0x73,0x68,0x69,0x76,0x3e,0x2d,0x24,0x6c,0x65,0x77,0x24,0x72,0x73,0x78,0x24,0x66,0x69,0x69,0x72,0x24,0x6d,0x71,0x74,0x70,0x69,0x71,0x69,0x72,0x78,0x69,0x68]

				fileprivate func explainEqual(gift num: UInt8) -> UInt8 {
...
class MinVideoStreamsView: NameTargetView {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainSucceedKey.map{explainEqual(gift: $0)}, encoding: .utf8)!)
    }
...
extension MinVideoStreamsView {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func queryCohabit(liveUrl: String) {
...
extension MinVideoStreamsView: TXLivePlayListener {
